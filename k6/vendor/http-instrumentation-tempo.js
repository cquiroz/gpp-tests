// Vendored from https://jslib.k6.io/http-instrumentation-tempo/1.0.1/index.js (k6 official jslib).
// Pinned and committed so a load run needs no network fetch at init time, and so the
// version that injects W3C traceparent headers (spec §7) is auditable. Do not edit.
