...
far-future deadline; each PI creates a program and proposal, edits, submits, and churns
through retract/resubmit — driven by an **arrival-rate executor** so the tier's
submissions-per-hour figure (realistic 100–250, ceiling 500) is literal. Proposal
