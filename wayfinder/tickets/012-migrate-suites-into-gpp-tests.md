...
Move the prototype out of `cquiroz/gpp-tests` into `gemini-hlsw/gpp-tests` as a production repo:
...
suite needs (spec, relevant `research/`, `CONTEXT.md`); README points back to the prototype
