...
export const SCENARIOS = [
  ...
  {
    key: "proposal-submit",
    e2e: ["scenario 4: the ODB refuses to submit the proposal without its attachments"],
    k6: null,
    reason:
      "Same blocker as proposal-call: k6 has no standard-user auth yet. Since 2026-09-07 the " +
      "ODB also requires a Science and a Team attachment to submit, so the submit/retract " +
      "lifecycle waits for an object store in the stack (wayfinder ticket 028) at both layers.",
  },
  {
